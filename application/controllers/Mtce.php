...
class Mtce extends Application {
    ...
    private function showit()
    {
        ...
        $fields = array(
            ...
            'fsize' => makeComboBox('Size', 'size', $task->size, $sizes, "What is the size of the task?"),
            'fgroup' => makeComboBox('Group', 'group', $task->group, $groups, "Which group does this task belong to?"),
            'fstatus' => makeComboBox('Status', 'status', $task->status, $status, "What is the status of this task?"),
